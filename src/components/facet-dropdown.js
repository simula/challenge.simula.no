    ...
    return (
        <div ref={containerRef} className="relative inline-block text-left">
            <button
                ...
                className={`focus-visible:ring-primary inline-flex min-h-9 items-center gap-1.5 rounded-full border px-3 py-1.5 text-sm transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 ${
                    isActive
